...
public class SupprimerMobilier extends javax.swing.JDialog {
     ...
     * @param mobilier
     */
    public SupprimerMobilier(Frame parent, boolean modal, MobilierFrame mobilierFrame, Mobilier mobilier, CrudMobilier crudMobilier) {
        super(parent, modal);
    ...
    private void deleteButton() {
        try {
            crudMobilier.deleteMobilier(mobilier.getId());
